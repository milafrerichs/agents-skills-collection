...
describe('isValidEmail', () => {
  it('validates email: missing @', () => {
    expect(isValidEmail('userexample.com')).toBe(false)
  })

  it('validates email: missing domain', () => {
    expect(isValidEmail('user@')).toBe(false)
  })

  it('validates email: missing local part', () => {
    expect(isValidEmail('@example.com')).toBe(false)
  })

  it('validates email: valid simple', () => {
    expect(isValidEmail('user@example.com')).toBe(true)
  })

  it('validates email: valid with dots', () => {
...
Reference: [Vitest test.each](https://vitest.dev/api/#test-each)
