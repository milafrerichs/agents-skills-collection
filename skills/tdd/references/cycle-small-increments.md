...
impact: CRITICAL
impactDescription: 2-5x faster debugging from smaller change sets
...
describe('user registration', () => {
  it('registers user with validation and email', async () => {
...
describe('createUser', () => {
  it('creates user with email and name', () => {
...
describe('createUser', () => {
  it('starts with unverified email', () => {
    const user = createUser({ email: 'test@example.com', name: 'John' })
