...
```typescript
describe('order generation', () => {
  it('generates order id with date prefix', () => {
    // Inject fixed clock
...
describe('token', () => {
  it('expires 1 hour after creation', () => {
    vi.useFakeTimers()
